...
} from "../../../../apis/categories/category.interface";
import { useSnackbar } from "../../../../common/contexts/snackbar.context";

const SWR_KEY = "admin-categories";

export const CategoriesTab: React.FC<{ search?: string }> = ({
  search = "",
}) => {
  const { showSnackbar } = useSnackbar();
  const [open, setOpen] = useState(false);
  const [editing, setEditing] = useState<Category | null>(null);
  const [form, setForm] = useState<RequestCreateCategoryDto>({
    name: "",
    slug: "",
  });
  ...
  const { data: categories, isLoading } = useSWR<Category[]>(SWR_KEY, () =>
