...
export const ProductDetailScreen: React.FC = () => {
  ...
  const { data: detail, isLoading } = useSWR<ProductDetail | null>(
    ...
    () =>
      getShopProductById(id!).then((r) =>
        (r as { data?: { data?: ProductDetail } | ProductDetail })?.data &&
        "data" in ((r as { data?: unknown }).data as object)
  ...
  const { data: relatedProducts } = useSWR<Product[]>(
    ...
    () =>
      getProductRelations(
        ...
        (r as { data?: { data?: Product[] } | Product[] })?.data &&
        "data" in ((r as { data?: unknown }).data as object)
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography
              sx={{ fontSize: 32, fontWeight: 800, color: "#1a1a1a", mb: 2 }}
            >
