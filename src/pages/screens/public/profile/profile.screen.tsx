...
} from "../../../../apis/profiles/profile.interface";
...
const EMPTY_ADDR: RequestCreateAddressDto = {
  label: "",
  street: "",
  city: "",
  country: "",
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            ...
            >
              ...
              <Box>
                <Typography
                  sx={{ fontWeight: 700, fontSize: 16, color: "#1a1a1a" }}
                >
                  {user?.full_name}
                </Typography>
            ...
            <Typography
              sx={{ fontWeight: 700, fontSize: 15, mb: 2, color: "#1a1a1a" }}
            >
              Change Password
            </Typography>
            <TextField
      ...
      >
        ...
        <DialogContent>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, pt: 1 }}>
            ...
            <Box
              onClick={() =>
                setAddrForm((f) => ({ ...f, is_default: !f.is_default }))
              }
              sx={{
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              <Typography
                sx={{
                  fontSize: 14,
                  fontWeight: addrForm.is_default ? 600 : 400,
                }}
              >
