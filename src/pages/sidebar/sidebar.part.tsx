...
import { clearSession, getStoredUser, isAuthenticated } from '../../common/utils/auth-session';
...
export const Sidebar: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <List sx={{ px: 1 }}>
                ...
                <ListItemButton
                    ...
                    sx={{
                        ...
                        justifyContent: collapsed ? 'center' : 'initial',
                        px: collapsed ? 1.5 : 2,
                        color: location.pathname === '/admin' ? COLOR_BRAND.accent : '#aaa',
                        mt: 1.25,
            ...
            <Box sx={{ mt: 'auto', p: 1.25, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
                <Box
                    ...
                    sx={{
                        ...
                        '&:hover': {
                            backgroundColor: authenticated ? 'rgba(255,255,255,0.05)' : 'rgba(232,255,71,0.08)',
                        },
                    }}
                >
                    <Box
                    ...
                    >
                        {authenticated ? (user?.full_name?.[0] ?? 'U').toUpperCase() : '↪'}
                    </Box>
                    {!collapsed && (
                        <Box sx={{ overflow: 'hidden' }}>
                            <Typography sx={{ color: COLORS.white, fontSize: 13, fontWeight: 500, whiteSpace: 'nowrap' }} noWrap>
                                {authenticated ? (user?.full_name || 'User') : 'Sign in'}
                            </Typography>
                            <Typography sx={{ color: '#aaa', fontSize: 11, whiteSpace: 'nowrap' }} noWrap>
                                {authenticated ? (user?.email || 'Administrator') : 'Access your account'}
                            </Typography>
                        </Box>
                    )}
                </Box>
