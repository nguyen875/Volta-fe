...
export const getAllProduct = (params?: ProductRequestParam): Promise<ApiResponse<PaginatedResponse<Product>>> => {
...
export const createProduct = (product: RequestCreateProductDto): Promise<ApiResponse<Product>> => {
    return axiosInstance.post(`${BASE_URL}`, product);
}

export const updateProduct = (id: string, product: RequestCreateProductDto): Promise<ApiResponse<Product>> => {
...
export const getAllProductImage = (id: string): Promise<ApiResponse<ProductImage[]>> => {
    return axiosInstance.get(`${BASE_URL}/${id}/images`);
}

export const uploadProductImage = (id: string, imaged: File[]): Promise<ApiResponse<ProductImage[]>> => {
...
export const deleteProductImage = (id: string, imageId: string): Promise<ApiResponse<void>> => {
    return axiosInstance.delete(`${BASE_URL}/${id}/images/${imageId}`);
}

export const setProductImagePrimary = (id: string, imageId: string): Promise<ApiResponse<void>> => {
    return axiosInstance.put(`${BASE_URL}/${id}/images/${imageId}/primary`);
}

export const getProductRelations = (id: string, type: ProductRelationType): Promise<ApiResponse<Product[]>> => {
...
export const createProductRelation = (id: string, body: CreateProductRelationDTO): Promise<ApiResponse<void>> => {
    return axiosInstance.post(`${BASE_URL}/${id}/relations`, body);
}

export const deleteProductRelation = (id: string, related_id: string): Promise<ApiResponse<void>> => {
