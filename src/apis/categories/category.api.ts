...
export const createCategory = (body: RequestCreateCategoryDto): Promise<ApiResponse<Category>> => {
...
export const updateCategory = (id: number, body: RequestCreateCategoryDto): Promise<ApiResponse<Category>> => {
