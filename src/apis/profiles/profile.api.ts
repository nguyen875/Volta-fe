...
export const updateProfile = (body: UpdateProfileDto): Promise<ApiResponse<UserProfile>> => {
...
export const createAddress = (body: RequestCreateAddressDto): Promise<ApiResponse<Address>> => {
  return axiosInstance.post(`${BASE_URL}/addresses`, body);
}

export const updateAddress = (id: number, body: RequestCreateAddressDto): Promise<ApiResponse<Address>> => {
